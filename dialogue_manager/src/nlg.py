...
dialogue = {"general":  ["I couldn't understand what you said. Can you please repeat it?",
            ...
            "introduction": ["Hi", #Wave
                            ...
                            " We will do each exercise three times focussing on these time periods. With this, we aim to help you reflect on all three time periods in your life, and cast our attention towards the future.",
                            # "First, we will talk about impactful events in your life. Next, we will do a gratitude building exercise, and then an exercise focusing on your accomplishments. You can go into as much or as little detail as you'd like.",
            ...
            "past":     {"impactful": [" First, let's talk about three impactful things that happened in your past - any three things that affected you in the recent past, in the past month or a few weeks. Can you tell me any three impactful things? You can start telling me the first one.",
            ...
            "present": {"impactful": [" Now we will move on to talking about the present. Please think about three things that are currently impacting you. They don't need to be positive  or negative, these can be any three things that are affecting you currently. Could you please tell me three impactful things, one at a time? Please start.",
