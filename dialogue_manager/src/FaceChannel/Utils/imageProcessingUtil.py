...
class imageProcessingUtil:
    ...
    def __init__(self):
        ...
        prototxtPath = os.path.join(parentDir, "TrainedNetworks", "faceDetector", "deploy.prototxt")
        weightsPath = os.path.join(parentDir, "TrainedNetworks", "faceDetector", "res10_300x300_ssd_iter_140000.caffemodel")
