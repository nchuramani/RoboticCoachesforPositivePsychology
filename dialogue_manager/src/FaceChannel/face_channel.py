...
lm.separate(1)
lm.write('Final image size: ' + str(finalImageSize[0]) + 'x' + str(finalImageSize[1]) + '\n' +
        'Frame size: ' + str(frameSize[0]) + 'x' + str(frameSize[1]) + '\n' +
...
def callback(data):
        ...
        # creates the display image and copies the captured frame to it
        image = numpy.zeros((finalImageSize[1], finalImageSize[0], 3), numpy.uint8)
        image[0:frameSize[0], 0:frameSize[1]] = frame
        frame = image
